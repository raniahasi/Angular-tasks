...
- Create Angular project with ng: `ng new ang1.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`ang1.client.esproj`).
- Create `launch.json` to enable debugging.
- Create `nuget.config` to specify location of the JavaScript Project System SDK (which is used in the first line in `ang1.client.esproj`).
